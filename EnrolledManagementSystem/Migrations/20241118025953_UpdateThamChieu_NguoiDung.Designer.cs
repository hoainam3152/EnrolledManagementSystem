...
namespace EnrolledManagementSystem.Migrations
{
    ...
    [Migration("20241118025953_UpdateThamChieu_NguoiDung")]
    partial class UpdateThamChieu_NguoiDung
    {
            ...
            modelBuilder.Entity("EnrolledManagementSystem.Entities.GiangVien", b =>
                {
                    ...
                    b.HasOne("EnrolledManagementSystem.Entities.NguoiDung", "NguoiDung")
                        .WithOne("GiangVien")
                        .HasForeignKey("EnrolledManagementSystem.Entities.GiangVien", "MaNguoiDung");
            ...
            modelBuilder.Entity("EnrolledManagementSystem.Entities.HocVien", b =>
                {
                    ...
                    b.HasOne("EnrolledManagementSystem.Entities.NguoiDung", "NguoiDung")
                        .WithOne("HocVien")
                        .HasForeignKey("EnrolledManagementSystem.Entities.HocVien", "MaNguoiDung");
            ...
            modelBuilder.Entity("EnrolledManagementSystem.Entities.NhanVien", b =>
                {
                    ...
                    b.HasOne("EnrolledManagementSystem.Entities.NguoiDung", "NguoiDung")
                        .WithOne("NhanVien")
                        .HasForeignKey("EnrolledManagementSystem.Entities.NhanVien", "MaNguoiDung");
