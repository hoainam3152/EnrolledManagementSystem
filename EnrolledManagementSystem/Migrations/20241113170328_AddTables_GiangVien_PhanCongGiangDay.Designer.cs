...
namespace EnrolledManagementSystem.Migrations
{
    ...
    [Migration("20241113170328_AddTables_GiangVien_PhanCongGiangDay")]
    partial class AddTables_GiangVien_PhanCongGiangDay
    {
            ...
            modelBuilder.Entity("EnrolledManagementSystem.Entities.GiangVien", b =>
                {
                    ...
                    b.Property<string>("MaMonDayKiemNhiem")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("EnrolledManagementSystem.Entities.GiangVien", b =>
                {
                    ...
                    b.HasOne("EnrolledManagementSystem.Entities.MonHoc", "MonKiemNhiem")
                        .WithMany()
                        .HasForeignKey("MaMonDayKiemNhiem");

                    b.Navigation("MonChinh");

                    b.Navigation("MonKiemNhiem");
                });
